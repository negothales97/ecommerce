                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                        <label for="input-price">{{ __('Preço Original') }}</label>
                                        <div class="input-group">
                                            ...
                                            <input id="input-price"
                                                ...
                                                value="{{ convertMoneyUSAToBrazil(old('price', $product->price)) }}"
                                                required="true" aria-required="true" />
                                        </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group{{ $errors->has('weight') ? ' has-danger' : '' }}">
                                        <input
                                            ...
                                            value="{{ convertMoneyUsaToBrazil(old('weight', $product->weight)) }}"
                                            required="true" aria-required="true" />
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group{{ $errors->has('depth') ? ' has-danger' : '' }}">
                                        <input
                                            ...
                                            value="{{ convertMoneyUsaToBrazil(old('depth', $product->depth)) }}"
                                            required="true" aria-required="true" />
                                        @if ($errors->has('depth'))
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group{{ $errors->has('width') ? ' has-danger' : '' }}">
                                        <input
                                            ...
                                            value="{{ convertMoneyUsaToBrazil(old('width', $product->width)) }}"
                                            required="true" aria-required="true" />
                                        @if ($errors->has('width'))
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group{{ $errors->has('height') ? ' has-danger' : '' }}">
                                        <input
                                            ...
                                            value="{{ convertMoneyUsaToBrazil(old('height', $product->height)) }}"
                                            required="true" aria-required="true" />
