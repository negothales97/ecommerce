...
var inputRadioPF = document.querySelector('#radio-pf');
var inputRadioPJ = document.querySelector('#radio-pj');
inputRadioPF.addEventListener("click", function () {
  toggleDocument("pf");
});
inputRadioPJ.addEventListener("click", function () {
  toggleDocument("pj");
});

var toggleDocument = function toggleDocument(typeDocument) {
  if (typeDocument == "pf") {
...
__webpack_require__(/*! C:\xampp\htdocs\ecommerce\backend\resources\js\app.js */"./resources/js/app.js");
__webpack_require__(/*! C:\xampp\htdocs\ecommerce\backend\resources\sass\app.scss */"./resources/sass/app.scss");
module.exports = __webpack_require__(/*! C:\xampp\htdocs\ecommerce\backend\resources\sass\admin.scss */"./resources/sass/admin.scss");
