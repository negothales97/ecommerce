...
function getCategory(element) {
  ...
  axios.get("".concat(url, "?company_slug=").concat(companySlug)).then(function (response) {
...
function createMenuCategory(category, companySlug) {
  ...
  if (hasSubcategory) {
    ...
    buttonElement.bind({
      click: function click() {
        window.location.href = "".concat(category.links.main, "/pt-br/").concat(companySlug, "/").concat(category.links.category, "/");
      }
    });
  }
...
function createMenuSubCategory(subcategories, companySlug) {
  ...
  subcategories.forEach(function (subcategory) {
    ...
    buttonElement.bind({
      click: function click() {
        window.location.href = "".concat(subcategory.links.main, "/pt-br/").concat(companySlug, "/").concat(subcategory.links.category, "/");
      }
    });
    submenu.append(buttonElement);
  });
...
module.exports = __webpack_require__(/*! C:\xampp\htdocs\ecommerce\backend\resources\js\mobile.js */"./resources/js/mobile.js");
