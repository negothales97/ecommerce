...
class CreateSubproductVariationOptionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('subproduct_variation_options', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('subproduct_variation_options');
    }
}
