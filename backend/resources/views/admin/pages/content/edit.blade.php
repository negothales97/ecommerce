...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-1 text-dark">Editar Conteúdo</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-info card-outline">
                        <form action="{{route('admin.content.update', ['resourceId' => $resource->id])}}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="title_pt_BR" id="title_pt_BR" value="{{$resource->title_pt_BR}}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="title_en" id="title_en" value="{{$resource->title_en}}">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="link" id="link" value="{{$resource->link}}">
                                            @if ($errors->has('link'))
                                            <span class="help-block">
                                                <small>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="resume_pt_BR" id="input-resume_pt_BR"
                                                ...
                                                required rows="5">{{$resource->resume_pt_BR}}</textarea>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="resume_en" id="input-resume_en"
                                                ...
                                                required rows="5">{{$resource->resume_en}}</textarea>
